...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Specflow", "Feature1", "A short summary As a TurnUp portal admin\r\nI would like to create, edit and delete" +
                    " time and material records\r\nSo that I can manage employees\' time and materials s" +
                    "uccessfully", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 11
 testRunner.When("I create a new time and materail record", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 12
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Time", "Roshan", "100", null)]
        [NUnit.Framework.TestCaseAttribute("Material", "KEyboard", "200", null)]
        [NUnit.Framework.TestCaseAttribute("EditedRecord", "Mouse", "300", null)]
...
#line hidden
#line 18
 testRunner.When(string.Format("I update \'{0}\',\'{1}\' and \'{2}\' on exsisting time and materail record", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 19
